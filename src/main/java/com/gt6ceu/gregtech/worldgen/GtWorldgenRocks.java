 ...
 * Source: gregtech/worldgen/WorldgenRocks.java
 * Purpose: Place loose surface rocks in eligible biomes.
 * Status: PORTED
...
public class GtWorldgenRocks implements GtChunkWorldgen {
    private final String id;
    private final int amount;
    private final int probability;

    public GtWorldgenRocks(String id, int amount, int probability) {
        this.id = id;
        this.amount = amount;
    ...
    private boolean isAllowedBiome(Biome biome) {
        return biome.is(BiomeTags.IS_DESERT)
